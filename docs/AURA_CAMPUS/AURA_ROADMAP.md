...
| 10 | [roadmap/10-phase8-mobile-apps.md](roadmap/10-phase8-mobile-apps.md) | Phase 8 — React Native Mobile Apps & CCTV (8A–8F / P8.1–P8.6) | 🟡 In progress — Sprint 1: Smart Campus foundation landed |
...
Phase 8    ███████████░░░░░░░░░░░░░░░░░░░░  ~35% (8A ✅ · 8B/8C/8F screens built (Expo-Go) · 8F parent app: authed /api/parent + read-only child screens · Sprint 1 Smart Campus foundation ✅ (Classroom/NFC tag/card reader registries + admin UI + EAS dev-client scaffolding) · NFC/push/CCTV ingest + in-app pay need EAS/device)
