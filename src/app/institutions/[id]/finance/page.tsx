...
export default function FinancePage({
  ...
  return (
    <DashboardLayout>
      <div className="flex flex-col gap-4 px-6 pt-3 pb-4 h-[calc(100vh-56px)] overflow-y-auto">

        {/* ── Page header ── */}
        <div className="flex items-center justify-between flex-wrap gap-3 shrink-0">
          <div>
            <Link
              href={`/institutions/${tenantId}`}
              className="inline-flex items-center gap-1 text-[11px] text-slate-400 hover:text-violet-600 transition-colors mb-1"
            >
          ...
          <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 shrink-0">
              ...
              <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-4">
                ...
                <div className="grid grid-cols-2 gap-1.5">
                  {[
                    { label: "Fee Structures", href: `/institutions/${tenantId}/finance/fees` },
                    { label: "All Payments",   href: `/institutions/${tenantId}/finance/fees/payments` },
                    { label: "Salaries",       href: `/institutions/${tenantId}/finance/salary` },
                    { label: "Reports",        href: `/institutions/${tenantId}/finance/reports` },
                  ].map((link) => (
                    <Link
                      key={link.href}
                      href={link.href}
            ...
            <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden flex-1 min-h-0 flex flex-col">
              <div className="flex items-center justify-between px-4 py-3 border-b border-slate-100 shrink-0">
                ...
                <Link
                  href={`/institutions/${tenantId}/finance/fees/payments`}
