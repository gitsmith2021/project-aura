...
describe("matchIntent", () => {
  ...
  it("routes Batch-B questions (finance overview / payroll / budget)", () => {
    expect(matchIntent("show me the finance overview", INTENTS, "INST_ADMIN")?.intent.id).toBe("finance.overview");
