...
import { nextStatus, checkEligibility, concessionTypeForScheme, formatINR, isDeadlinePassed, scholarshipStats, applicationsCSV, STATUS_PIPELINE, SCHEME_TYPES, type ScholarshipApplication } from "@/lib/scholarships";
